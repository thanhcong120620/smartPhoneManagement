...
<div class="lefttop">
    ...
    <div class="menu">
        <ul>
            <li><i class="far fa-address-card"></i><a href="#">Dashboard</a></li>
            <li><i class="fas fa-user-alt"></i><a href="#">Staff Manager</a></li>
            <li><i class="fas fa-shopping-cart"></i><a href="#">Product Manager</a></li>
        </ul>
    </div>
